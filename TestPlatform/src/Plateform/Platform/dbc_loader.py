...
# Public class alias expected by tests
class DBCLoader:
    """Thin class wrapper around the load_dbc() function."""
    ...
    def load(self, path: str):
        self.data = load_dbc(path)
        self.messages = self.data.get("messages") if self.data else None
        return self.data
